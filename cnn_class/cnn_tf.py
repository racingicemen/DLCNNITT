...
def main():
    train = loadmat('/home/rkk/kaggle/SVHN/train_32x32.mat') # N = 73257
    test  = loadmat('/home/rkk/kaggle/SVHN/test_32x32.mat') # N = 26032
                ...
                if len(Xbatch) == batch_sz:
                    ...
                    if j % print_period == 0:
                        ...
                        for k in range(int(len(Xtest) / batch_sz)):
                            ...
                            Ytestbatch = Ytest_ind[k*batch_sz:(k+1)*batch_sz,:]
                            test_cost += session.run(cost, feed_dict={X: Xtestbatch, T: Ytestbatch})
                            prediction[k*batch_sz:(k+1)*batch_sz] = session.run(
